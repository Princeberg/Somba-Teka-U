          ...
          <div className="header-left">
            <Link href="/boutique/menu" legacyBehavior>
              <a className="logo" onClick={closeMenu}>
                ...
                <span className="logo-main">TEKA</span>
              </a>
            </Link>
          </div>
              ...
              <ul>
                <li>
                  <Link href="/boutique/menu" legacyBehavior>
                    <a
                      onClick={closeMenu}
                      className={`nav-link ${router.pathname === "/boutique/menu" ? "active" : ""}`}
                    >
                ...
                <li>
                  <Link href="/boutique/demande" legacyBehavior>
                    <a
                      onClick={closeMenu}
                      className={`nav-link ${router.pathname === "/boutique/demande" ? "active" : ""}`}
                    >
                ...
                <li>
                  <Link href="/boutique/view" legacyBehavior>
                    <a
                      onClick={closeMenu}
                      className={`nav-link ${router.pathname === "/boutique/view" ? "active" : ""}`}
                    >
          ...
          <div className="header-right">
            ...
            <Link href="/logout" legacyBehavior>
              <a className="auth-button" onClick={closeMenu}>
                ...
                <span className="auth-text">{translations.logout}</span>
              </a>
            </Link>
