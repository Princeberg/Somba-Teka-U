        ...
        <div className="container">
              ...
              <ul>
                ...
                <li>
                  <Link href="/ad" legacyBehavior>
                    <a
                      onClick={closeMenu}
                      className={`nav-link ${router.pathname === "/ad" ? "active" : ""}`}
                    >
                      <FontAwesomeIcon icon={faBullhorn} className="nav-icon" />
                      <span className="nav-text">Publicité</span>
                    </a>
                  </Link>
                </li>
                <li>
          ...
          <div className="header-right">
            ...
            <Link href="/login" legacyBehavior>
              <a
                className={`auth-button ${router.pathname === "/login" ? "active" : ""}`}
                onClick={closeMenu}
              >
                <FontAwesomeIcon icon={faUser} className="auth-icon" />
                <span className="auth-text">Espace Vendeur</span>
              </a>
            </Link>
